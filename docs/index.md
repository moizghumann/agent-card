...
- [Agent Guide](../AGENTS.md): how future agents should work safely in this repo.
- [Architecture](../ARCHITECTURE.md): current app structure, boundaries, and data flow.
...
- [Plans](plans/index.md): active and completed execution plans.
- [README](../README.md): setup, run commands, and usage.
